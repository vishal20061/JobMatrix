...
// import { MapPin, Briefcase, DollarSign, Users, Calendar, Award, ChevronRight } from 'lucide-react';
...
//                                 disabled={isApplied}
//                                 className={`px-10 py-5 rounded-[1.5rem] font-black text-lg transition-all duration-500 shadow-2xl ${
//                                     isApplied 
...
const JobDescription = () => {
    ...
    useEffect(() => {
        ...
        if (localSavedJobs) {
            dispatch(setSavedJobs(JSON.parse(localSavedJobs)));
        }
    }, [dispatch]);
